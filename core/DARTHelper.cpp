	...
	for(TiXmlElement* node = skeleton_elem->FirstChildElement("Node");node != nullptr;node = node->NextSiblingElement("Node"))
	{
		...
		if(type == "Box")
		{
			...
			if ((name=="TibiaL")||(name=="TibiaR"))
				 size[1]-= 0.11;            // change human tibia y-axis scale
			shape = MASS::MakeBoxShape(size);
		}
		else if(type=="Sphere")
		{
		...
		if ((name=="TibiaL")||(name=="TibiaR"))
		    T_body.translation()[1]+=0.055; 
		else if ((name=="TalusL")||(name=="TalusR"))
		    T_body.translation()[1]+=0.11; 
		else if ((name=="FootThumbR")||(name=="FootThumbL"))
		    T_body.translation()[1]+=0.11; 
		else if ((name=="FootPinkyR")||(name=="FootPinkyL"))
		    T_body.translation()[1]+=0.11; 
		...
		// 	if (name == "TibiaL") 
		// 	 {
		// 		 visual_shape->setScale(Eigen::Vector3d(0.01*1,0.01*0.735,0.01*1));
		// 		 auto vsn = bn->createShapeNodeWith<VisualAspect>(visual_shape);
		// 		 T_obj = T_body.inverse();
		// 		 T_obj.translation()(1) = T_obj.translation()(1)+0.11; 
		// 		 vsn->setRelativeTransform(T_obj);
		// 	}
		// 	else if (name == "TibiaR")
		//     {
		...
		// 		 vsn->setRelativeTransform(T_obj);
		// 	 }
		// 	else if ((name == "TalusL")||(name == "FootThumbL")||(name == "FootPinkyL"))
		// 	{   
		// 		 auto vsn = bn->createShapeNodeWith<VisualAspect>(visual_shape);
		// 		 T_obj = T_body.inverse();
		// 		 T_obj.translation()(1) = T_obj.translation()(1)+0.11; 
		...
		// 	}
		// 	else if ((name == "TalusR")||(name == "FootThumbR")||(name == "FootPinkyR"))
		// 	{   
		// 		 auto vsn = bn->createShapeNodeWith<VisualAspect>(visual_shape);
		// 		 T_obj = T_body.inverse();
		// 		 T_obj.translation()(1) = T_obj.translation()(1)-0.11; 
